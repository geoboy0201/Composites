function [MxMaxTsaiWu]=compositePlateFailureTsaiWuMx(laminate,L,W)
...
for i=2:2:length(sigma1)
    ...
    C1=(F11*sigma1(i)^2+F22*sigma2(i)^2+F66*tau12(i)^2);
    ...
    C1=(F11*sigma1(i-1)^2+F22*sigma2(i-1)^2+F66*tau12(i-1)^2);
...
[MxMaxTsaiWu,I]=min(abs(MxMax),[],'all','linear');
MxMaxTsaiWu=MxMax(I);
